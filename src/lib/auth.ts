 ...
 * @description
 * This file configures the 'better-auth' library, which is your application's
 * complete solution for handling user authentication (signup, login, sessions, etc.).
 * It integrates seamlessly with your Drizzle ORM database to manage user data.
 *
 * For a comprehensive list of all configuration options, please refer to the
 * [better-auth official documentation](https://www.better-auth.com/docs/introduction).
 */

// Import the main 'betterAuth' function.
import { betterAuth } from "better-auth";
// Import the Drizzle adapter to connect 'better-auth' with your Drizzle ORM setup.
import { drizzleAdapter } from "better-auth/adapters/drizzle";
// Import your initialized Drizzle ORM database client.
import { DrizzleDB } from "./Drizzle.js";
// Import your application's public URL, used for security configurations like trusted origins.
import { PUBLIC_URL } from "$env/static/public";

// Import your authentication-related database schemas. These define the tables
 ...
 * Use this object throughout your application to access authentication functionalities.
 *
 * @property {object} database - Configures how 'better-auth' interacts with your database.
 ...
 * @property {object} user.additionalFields - Allows adding custom fields to your user schema (e.g., 'role').
...
export const auth = betterAuth({
    database: drizzleAdapter(DrizzleDB, {
        ...
        schema: authentication // Links to your Drizzle schemas for authentication.
    }),
    session: {
    ...
    trustedOrigins: [`${PUBLIC_URL}`] // Ensures requests come from your application's URL.
});